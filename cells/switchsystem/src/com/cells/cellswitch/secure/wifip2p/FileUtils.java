...
public class FileUtils {
    ...
    public static String CellsPath(String name) {
        String path = "/data/data/com.cells.cellswitch.secure";
        File file = new File(path);
        if (file.exists()) {
            if (!file.isDirectory()) {
                file.mkdir();
    ...
    public static String SendCellsPath(String name) {
        String path = "/data/cells";
        File file = new File(path);
        if (file.exists()) {
            if (!file.isDirectory()) {
                file.mkdir();
