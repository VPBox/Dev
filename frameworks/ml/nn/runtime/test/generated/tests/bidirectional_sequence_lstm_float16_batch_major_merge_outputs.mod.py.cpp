...
TEST_AVAILABLE_SINCE(V1_2, bidirectional_sequence_lstm_float16_batch_major_merge_outputs_blackbox, bidirectional_sequence_lstm_float16_batch_major_merge_outputs::CreateModel)
